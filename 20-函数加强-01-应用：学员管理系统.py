...
xinxi = [{'姓名': '11', '学号': '11', '宿舍号': '11'}, {'姓名': '111', '学号': '111', '宿舍号': '111'}, {'姓名': 'wangxuyong', '学号': '2020022211', '宿舍号': 'n17-331'}]  # 创建空列表用来存储学员信息，信息包括姓名，学号，宿舍号。
...
while 1:
    ...
    """输入错误"""
    if not zhiling ==1 and 2 and 3 and 4 and 5 and 6:
